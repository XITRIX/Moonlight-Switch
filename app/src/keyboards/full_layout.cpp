...
void KeyboardView::createFullLayout()
{
    ...
    ButtonView* removeButton = new ButtonView();
    ...
    ButtonView* tabButton = new ButtonView();
    ...
    ButtonView* rshiftButton = new ButtonView();
    ...
    ButtonView* lctrlButton = new ButtonView();
    ...
    ButtonView* laltButton = new ButtonView();
    ...
    spaceButton->setWidth(514);
    row6->addView(spaceButton);

    ButtonView* leftButton = new ButtonView();
    ...
    ButtonView* upButton = new ButtonView();
    ...
    ButtonView* downButton = new ButtonView();
    ...
    ButtonView* rightButton = new ButtonView();
