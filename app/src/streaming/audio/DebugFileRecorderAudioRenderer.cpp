...
DebugFileRecorderAudioRenderer::~DebugFileRecorderAudioRenderer() {
    cleanup();
}

int DebugFileRecorderAudioRenderer::init(int audio_configuration, const POPUS_MULTISTREAM_CONFIGURATION opus_config, void *context, int ar_flags) {
    int error;
