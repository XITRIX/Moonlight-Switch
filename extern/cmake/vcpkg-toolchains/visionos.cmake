if(NOT _VCPKG_VISIONOS_TOOLCHAIN)
    ...
    macro(_vcpkg_setup_visionos_arch arch)
        ...
        if ("${arch}" STREQUAL "arm64")
            ...
            set(_vcpkg_visionos_sysroot "xros")
        elseif("${arch}" STREQUAL "x64")
            set(_vcpkg_visionos_system_processor "x86_64")
            set(_vcpkg_visionos_target_architecture "x86_64")
            set(_vcpkg_visionos_sysroot "xrsimulator")
        else()
            message(FATAL_ERROR
    ...
    if (DEFINED VCPKG_OSX_SYSROOT AND NOT VCPKG_OSX_SYSROOT STREQUAL "")
        set(_vcpkg_visionos_sysroot "${VCPKG_OSX_SYSROOT}")
    endif()
    ...
    if(_vcpkg_visionos_sysroot)
        set(CMAKE_OSX_SYSROOT ${_vcpkg_visionos_sysroot} CACHE STRING "visionOS sysroot")
    endif()
